<%-- 
    Document   : production
    Created on : Apr 5, 2019, 3:23:26 PM
    Author     : KiaraVaz
--%>
<%-- Kiara Vaz, April 22nd 2019
This where the user picks the day and time of theyre music production lessons
--%>
...
<html>
    ...
    <body>
        ...
        <h1 class="center">      Music Production Lesson Scheduling</h1>
        <div class="center" class="row" >
            <div class="inputGroup" >
                <%-- User Input
                --%>
                <form class="form" action="MPBook" method="POST">
