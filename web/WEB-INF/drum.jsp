<%-- 
    Document   : drum
    Created on : Apr 5, 2019, 3:23:15 PM
    Author     : KiaraVaz
--%>
<%-- Kiara Vaz, April 22nd 2019
This where the user picks the day and time of theyre drum lessons
--%>
...
<html>
    ...
    <body>
        ...
        <h1 class="center">      Drum Lesson Scheduling</h1>
        <div class="center" class="row" >
            <div class="inputGroup" >
                <%-- User Input
                --%>
                <form class="form" action="DBook" method="POST">
