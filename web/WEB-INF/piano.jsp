<%-- 
    Document   : piano
    Created on : Apr 5, 2019, 3:22:54 PM
    Author     : KiaraVaz
--%>
<%-- 
Kiara Vaz, April 22nd 2019
This where the user picks the day and time of theyre piano lessons
--%>
...
<html>
    ...
    <body>
        ...
        <h1 class="center">      Piano Lesson Scheduling</h1>
        <div class="center" class="row" >
            <div class="inputGroup" >
                <%-- User Input
                --%>
                <form class="form" action="PBook" method="POST">
